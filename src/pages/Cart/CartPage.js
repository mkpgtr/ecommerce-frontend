...
const CartPage = () => {
  ...
  // const [shipping] = useState(cart.length < 1 ? 0 : 40)
  ...
  // ! find all the logged in user's cart items and then filter the undefined values to get an array of values that are singleProducts
